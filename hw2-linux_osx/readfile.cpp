      ...
      if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
        ...
        if (cmd == "light") {
          if (numused == numLights) { // No more Lights 
            ...
            if (validinput) {
              ...
              lightposn[numused]     = values[0];
              lightposn[numused + 1] = values[1];
              lightposn[numused + 2] = values[2];
              lightposn[numused + 3] = values[3];
              lightcolor[numused]    = values[4];
              lightcolor[numused + 1]= values[5];
              lightcolor[numused + 2]= values[6];
              lightcolor[numused + 3]= values[7];
        ...
        // Also look at demo.txt to get a sense of why things are done this way.
          ...
          if (validinput) {
            ...
            mat4 translateMat = Transform::translate(x, y, z);
          ...
          if (validinput) {
            ...
            mat4 scaleMat = Transform::scale(sx, sy, sz);
          ...
          if (validinput) {
            ...
            ret[0][0] = rotateMat[0][0];
            ret[0][1] = rotateMat[0][1];
            ret[0][2] = rotateMat[0][2];
            ret[1][0] = rotateMat[1][0];
            ret[1][1] = rotateMat[1][1];
            ret[1][2] = rotateMat[1][2];
            ret[2][0] = rotateMat[2][0];
            ret[2][1] = rotateMat[2][1];
            ret[2][2] = rotateMat[2][2];
            ret[3][3] = 1.0;
